...
*)
let usage_msg =
  "fswatch.exe [-r|--recursive] [--event TYPE] [-i|--include REGEX] \
   [-e|--exclude REGEX] path\n\n\
   Requirements: Either DiskuvOCamlHome environment value must be defined or \
   `inotifywait` must be in the PATH.\n"
