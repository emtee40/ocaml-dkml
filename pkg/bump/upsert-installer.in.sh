...
idempotent_opam_local_install dkml-installer-ocaml_TRANSITIVE \
    '@dkml-compiler_SHORTREF@,@dkml-component-ocamlrun_SHORTREF@,@dkml-component-desktop_SHORTREF@,@dkml-component-opam_SHORTREF@,@dkml-component-unixutils_SHORTREF@,@dkml-component-ocamlcompiler_SHORTREF@,@dkml-install-api_SHORTREF@,@installer_COMMA_SHORTREF@' \
    '@PROJECT_SOURCE_DIR@' \
    ...
    '@dkml-component-ocamlcompiler_REL_SOURCE_DIR@/dkml-component-ocamlcompiler-offline.opam' @dkml-installer_SPACED_REL_OPAMFILES@
