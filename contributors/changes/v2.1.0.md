...
root@23c0e2f88029:/# apt-get update -y && apt-get install curl git build-essential -y
root@23c0e2f88029:/# curl --proto '=https' --tlsv1.2 -sSf -o /i.tar.gz https://gitlab.com/dkml/distributions/dkml/-/jobs/5666717637/artifacts/raw/dkml-native-linux_x86_64-i-2.1.0.tar.gz
root@23c0e2f88029:/# install -d /i && tar xCfz /i /i.tar.gz --strip-components 1
root@23c0e2f88029:/# CAML_LD_LIBRARY_PATH=/i/sg/staging-ocamlrun/linux_x86_64/lib/ocaml/stublibs /i/sg/staging-ocamlrun/linux_x86_64/bin/ocamlrun /i/bin/dkml-package.bc -v
root@23c0e2f88029:/# rm -rf /i /i.tar.gz

root@23c0e2f88029:/# ~/.local/share/dkml-native/usr/bin/utop
root@23c0e2f88029:/# ~/.local/share/dkml-native/bin/opam --version
```
