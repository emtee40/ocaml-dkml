...
DkMLBumpPackagesParticipant_DuneProjectFlavorUpgrade(dune-project)
DkMLBumpPackagesParticipant_DkmlFlavorOpamUpgrade(
    REL_FILENAME dkml-component-staging-desktop-ci.opam.template
    FLAVOR ci
    # - staging-withdkml already bundles the [with-dkml] package.
    # - The duplication with [staging-dkmlconfdir] is handled in
    #   the desktop .opam.template
    EXCLUDE_PACKAGES with-dkml)
DkMLBumpPackagesParticipant_DkmlFlavorOpamUpgrade(
    REL_FILENAME dkml-component-staging-desktop-full.opam.template
    FLAVOR full
    EXCLUDE_PACKAGES with-dkml)
