...
let global_env_vars =
  [
    ...
    ("PIN_DKML_COMPONENT_COMMON_OPAM", "2.2.0");
    ...
    ("PIN_DKML_COMPONENT_OFFLINE_OPAMSHIM", "2.2.0");
    ...
    ("PIN_DKML_COMPONENT_STAGING_OPAM32", "2.2.0");
    ("PIN_DKML_COMPONENT_STAGING_OPAM64", "2.2.0");
