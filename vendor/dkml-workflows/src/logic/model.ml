...
let global_env_vars =
  [
    ...
    ("PIN_DISKUVBOX", "0.2.0");
    ("PIN_DKML_APPS", "2.1.3");
    ("PIN_DKML_BASE_COMPILER", "4.14.2~v2.1.3");
    ("PIN_DKML_BUILD_DESKTOP", "2.1.3");
    ("PIN_DKML_C_PROBE", "3.0.0");
    ("PIN_DKML_COMPILER_SRC", "2.1.3");
    ("PIN_DKML_COMPONENT_COMMON_DESKTOP", "2.1.3");
    ("PIN_DKML_COMPONENT_COMMON_OPAM", "2.2.1");
    ("PIN_DKML_COMPONENT_COMMON_UNIXUTILS", "0.2.0");
    ("PIN_DKML_COMPONENT_OCAMLCOMPILER_COMMON", "4.14.2~v2.1.3");
    ("PIN_DKML_COMPONENT_OCAMLCOMPILER_NETWORK", "4.14.2~v2.1.3");
    ("PIN_DKML_COMPONENT_OCAMLCOMPILER_OFFLINE", "4.14.2~v2.1.3");
    ("PIN_DKML_COMPONENT_OFFLINE_DESKTOP_FULL", "2.1.3");
    ("PIN_DKML_COMPONENT_OFFLINE_OPAMSHIM", "2.2.1");
    ("PIN_DKML_COMPONENT_OFFLINE_UNIXUTILS", "0.2.0");
    ("PIN_DKML_COMPONENT_STAGING_DESKTOP_FULL", "2.1.3");
    ("PIN_DKML_COMPONENT_STAGING_DKMLCONFDIR", "2.1.3");
    ("PIN_DKML_COMPONENT_STAGING_OCAMLRUN", "4.14.2~v2.1.3");
    ("PIN_DKML_COMPONENT_STAGING_OPAM32", "2.2.1");
    ("PIN_DKML_COMPONENT_STAGING_OPAM64", "2.2.1");
    ("PIN_DKML_COMPONENT_STAGING_UNIXUTILS", "0.2.0");
    ("PIN_DKML_COMPONENT_STAGING_WITHDKML", "2.1.3");
    ("PIN_DKML_COMPONENT_XX_CONSOLE", "0.1.1");
    ("PIN_DKML_EXE_LIB", "2.1.3");
    ("PIN_DKML_EXE", "2.1.3");
    ...
    ("PIN_DKML_INSTALLER_OCAML_NETWORK", "2.1.3");
    ("PIN_DKML_PACKAGE_CONSOLE", "0.5.2");
    ("PIN_DKML_RUNTIME_COMMON_NATIVE", "2.1.1");
    ("PIN_DKML_RUNTIME_COMMON", "2.1.3");
    ("PIN_DKML_RUNTIME_DISTRIBUTION", "2.1.3");
    ("PIN_DKML_RUNTIMELIB", "2.1.3");
    ("PIN_DKML_RUNTIMESCRIPTS", "2.1.3");
    ("PIN_DKML_TARGET_ABI_WINDOWS_X86_64", "1");
    ("PIN_DKML_WORKFLOWS", "2.1.3");
