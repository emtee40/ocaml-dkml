...
export BOOTSTRAP_OPAM_VERSION='2.2.0.1'
...
export PIN_DKML_COMPONENT_COMMON_OPAM='2.2.0.1'
...
export PIN_DKML_COMPONENT_OFFLINE_OPAMSHIM='2.2.0.1'
...
export PIN_DKML_COMPONENT_STAGING_OPAM32='2.2.0.1'
export PIN_DKML_COMPONENT_STAGING_OPAM64='2.2.0.1'
