...
echo 'pinned: [
  ...
  "dkml-component-common-desktop.2.1.3"
  "dkml-component-common-opam.2.2.1"
  "dkml-component-common-unixutils.0.2.0"
  "dkml-component-ocamlcompiler-common.4.14.2~v2.1.3"
  "dkml-component-ocamlcompiler-network.4.14.2~v2.1.3"
  "dkml-component-ocamlcompiler-offline.4.14.2~v2.1.3"
  "dkml-component-offline-desktop-full.2.1.3"
  "dkml-component-offline-opamshim.2.2.1"
  "dkml-component-offline-unixutils.0.2.0"
  "dkml-component-staging-desktop-full.2.1.3"
  "dkml-component-staging-dkmlconfdir.2.1.3"
  "dkml-component-staging-ocamlrun.4.14.2~v2.1.3"
  "dkml-component-staging-opam32.2.2.1"
  "dkml-component-staging-opam64.2.2.1"
  "dkml-component-staging-unixutils.0.2.0"
  "dkml-component-staging-withdkml.2.1.3"
